...
Source0  : https://download.gnome.org/sources/atkmm/2.36/atkmm-2.36.1.tar.xz
...
%prep
%setup -q -n atkmm-2.36.1
cd %{_builddir}/atkmm-2.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621605183
...
cp %{_builddir}/atkmm-2.36.1/COPYING %{buildroot}/usr/share/package-licenses/atkmm/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/atkmm-2.36.1/COPYING.tools %{buildroot}/usr/share/package-licenses/atkmm/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
